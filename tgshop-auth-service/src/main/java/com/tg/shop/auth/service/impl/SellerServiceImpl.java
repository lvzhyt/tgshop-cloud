...
import com.tg.shop.core.utils.IdGeneratorUtil;
...
public class SellerServiceImpl implements SellerService {
    ...
    @Override
    public ResultState login(LoginForm loginForm) {
        Assert.notNull(loginForm.getLoginName(),"seller loginName is null");
        ...
        if(seller!=null){
            ...
            if(passwdMd5.equals(dbPasswd)){
                token = IdGeneratorUtil.randomUUID();
