package com.tg.shop.upload.config;
...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    public Docket createRestApi(){
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.tg.shop.upload"))
                .paths(pathSelector)
                .build()
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("API doc 接口文档")
                .description("File Upload API 接口. SwaggerEnable: "+swaggerEnable)
                .version("1.0")
                .build();
    }
